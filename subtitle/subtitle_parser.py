...
def parse(content: str, subtitle_format: SubtitleFormat = SubtitleFormat.AUTO, strip_text: bool = True) -> List[
    SubtitleEntry]:
    match subtitle_format:
        ...
        case _:
            return _parse_vtt(content, strip_text) if 'WEBVTT' in content[:20] else _parse_srt(content, strip_text)
